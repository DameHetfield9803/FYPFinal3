            ...
            <div className="container">
                ...
                <table className="table table-striped mt-3">
                    <tbody>
                        ...
                        <tr>
                            <td className="td-se-question">This team member completed the task assigned to our team.</td>
                        ...
                        <tr>
                            <td className="td-se-question">This team member did more than what was expected.</td>
                            <td>
                                <select
                        ...
                        <tr>
                            <td className="td-se-question">This team member contributed useful ideas.</td>
                            <td>
                                <select
