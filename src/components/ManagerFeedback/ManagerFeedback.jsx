                  ...
                  <tbody>
                    <tr>
                      <td className="td-se-question">
                        ...
                        eg: Have a good knowledge of job , aware of the key
                        result areas , performance standards and
                        responsibilities
                      </td>
                      <td>
                    ...
                    <tr>
                      <td className="td-se-question">
                        <b>Ability to meet deadlines </b> eg: Consistency to
                        meet the deadline
                      </td>
                      <td className="td-se-question">
                        <select onChange={(e) => setOptionTwo(e.target.value)}>
                    ...
                    <tr>
                      <td className="td-se-question">
                        ...
                        ideas and information in both oral and written form so
                        as to have the desired effect on the reader using
                        acceptable language, grammar and style bearing in mind
                        the culture and background.{" "}
                      </td>
                      <td className="td-se-question">
                        <select onChange={(e) => setOptionTwo(e.target.value)}>
                          <option value={0}>Choose option</option>
                    ...
                    <tr>
                      <td className="td-se-question">
                        <b>Decision-Making</b> eg: Able to make sound and
                        decisive decision
                      </td>
                      <td className="td-se-question">
                        <select onChange={(e) => setOptionTwo(e.target.value)}>
                    ...
                    <tr>
                      <td className="td-se-question">
                        ...
                        in approach and behavior to new and changed situations
